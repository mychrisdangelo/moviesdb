...
public class Profile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			while (r.next()) {
				if ((r.getString(1).equals(newemail))&&(newemail!=null)&&(!newemail.equals(" "))) {
					String duplicatedMessage = "UserName Occupied";
					request.setAttribute("loginError", duplicatedMessage);
